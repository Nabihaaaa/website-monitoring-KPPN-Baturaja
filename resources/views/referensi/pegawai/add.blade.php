        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <form id="allInputsFormValidation" method="post" enctype="multipart/form-data" action="{{url('referensi/pegawai/store')}}"
                    ...
                    <br>      
                    <button type="submit" class="btn btn-fill btn-info">Tambah</button>
                    </form>
                </div>
            </div>
        </div>
